...
public class TelaCadastrarSepultamento extends JInternalFrame {
	...
	public TelaCadastrarSepultamento() throws ParseException {
		...
		txtRaca.setModel(new DefaultComboBoxModel<String>(new String[] { "Branca", "Parda", "Preta", "Indígena" }));
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					if (txtFalecido.getText().isEmpty() || txtCausaMorte.getText().isEmpty()
						...
						JOptionPane.showMessageDialog(null, "Preencha todos os campos obrigatórios!", "", JOptionPane.ERROR_MESSAGE);
					} else if (!ValidaCPF.isCPF(txtCpf.getText().replace("-", "").replace(".", ""))) {
						JOptionPane.showMessageDialog(null, "Informe um CPF válido!", "", JOptionPane.ERROR_MESSAGE);
					} else if (txtTelefone.getText().equals(txtTelefone2.getText())) {
						JOptionPane.showMessageDialog(null, "Informe dois números de telefone diferente!", "",
	...
	public void CadastrarSepultamento() {
		...
		// JOptionPane.ERROR_MESSAGE);
		// } else if (teste != null) {
		// JOptionPane.showMessageDialog(this, "O número do CPF do Requerente já
		// está cadastrado no sistema!", "", JOptionPane.ERROR_MESSAGE);
		// } else if (txtTelefone.getText().equals(txtTelefone2.getText())) {
		// JOptionPane.showMessageDialog(this, "Informe dois números de telefone
